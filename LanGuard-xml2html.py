...
''' % ip
	...
	htmlContent += '''<li>OS: %s</li>
</ul>''' % os
	if len(host.getElementsByTagName('apps_installed')) == 0: continue
	htmlContent += '''<h2>List of installed applications</h2>
<table border="1">
<tr>
...
'''
	...
	htmlContent += '''<h2>List of vulnerabilities</h2>
<table border="1">
<tr>
...
'''
	...
	htmlContent += '''<h2>List of available hotfixes</h2>
<table border="1">
<tr>
...
print htmlContent.encode('utf-8')
